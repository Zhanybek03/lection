# Ассоция - принцип ООП, в котором два класса связаны друг с другом. Связь обозначает то что внутри одного обьекта будет существовать другой обьект от другого класса
...
# # при удалении iphone вместе с ним удаляюется батерейка
