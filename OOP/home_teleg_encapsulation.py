...
#     @property
#     def get_card_number(self):
#         return f'({self.name}, {self._phone_number}, {self.__card_number})' 
...
#     @get_card_number.setter
#     def setter_card_number(self):
#         return self.__card_number
